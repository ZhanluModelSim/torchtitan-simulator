...
"""
Estimation helpers for :class:`OpNode` performance modelling.

Provides overlap strategies, mock hardware constants, and heuristic
functions that estimate FLOPs, memory traffic, and communication
volume from tensor shapes and op names.
"""
