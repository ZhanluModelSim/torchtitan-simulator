...
"""
Schedule-graph linking and multi-rank step time prediction.

Bridges the coarse-grained :class:`TrainingSchedule` and the fine-grained
:class:`ComputeGraph` so that a discrete-event simulation can predict
end-to-end step time across multiple ranks.
"""
